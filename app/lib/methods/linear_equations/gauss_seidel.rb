...
module Methods::LinearEquations::GaussSeidel
  class << self
    def exec(matrix, vector, x0, norm, tolerance = 0.0000001, nmax = 100)
      ...
      # Jacobi Logic
      _T = Methods::Utils::Matrix.matrix_multiply(Methods::Utils::Matrix.matrix_inverse(Methods::Utils::Matrix.matrix_substract(_D, _L)), _U)
      _C = Methods::Utils::Matrix.matrix_vector_multiply(Methods::Utils::Matrix.matrix_inverse(Methods::Utils::Matrix.matrix_substract(_D, _L)), vector)
